import { Home, Calendar, Brain, BookOpen, Target, LayoutDashboard, CheckSquare, Sparkles, Lock, Bot } from 'lucide-react';
...
const TABS = [
  ...
  { id: '/agents', label: 'Agents', icon: Bot, color: '#c084fc' },
